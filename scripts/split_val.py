...
data_root = "/home/shaoqing/data/AGIBOT/Manipulation-SimData"

# task_names = os.listdir(data_root)
task_names = ["clear_table_in_the_restaurant"]

# print(task_names)

for task_name in task_names:

    prefix = f"{data_root}/{task_name}"
